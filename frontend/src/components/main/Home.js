                    ...
                    <div className="col-lg-10">
                      <div className="text-white pb-md-5">
                        <h1 className="my-md-5 mb-4 px-4 px-md-5 display-3 fw-bold ls-tight">
                          <span>The best Start Up's on the market</span> <br />{" "}
            ...
            <div className="row align-items-center">
              <div className="col-md-6 mb-4 mb-md-0">
                <h2 className="mb-4 display-3 fw-bold ls-tight">
                  ...
                  <span className="text-primary">for an Investment?</span>{" "}
                </h2>
              </div>
              <div className="col-md-6 mb-4 mb-md-0">
                ...
                <p className="text-muted lead">
                  We provide a number of profitable start up's for you. So our
                  investors can easily find a best profitable Start up for the
                  investment.
                </p>
              </div>
            </div>
              ...
              <div className="col-lg-7 mb-4 mb-md-0">
                <div className="bg-warning h-100 rounded-6 p-4 ps-lg-5 text-white d-flex align-items-center">
                  <div className="ps-lg-5">
                    ...
                    <p className="">
                      Do you need money or wants to get more profit.? Then here
                      we are providing you a bunch of small to&nbsp; large Start
                      up's so you can investment as much as you want
                    </p>
                    ...
                    <p>
                      On this website we are not only helping the investors to
                      find a best start up for there investment but we are also
                      helping Start ups to attracte the investors towards them
                      so the Start ups can grow much faster. We provides our
                      visitor a best quality and experience. We have a best team
                      for doing this job so our investors and start ups can
                      easily find eachother and grow simultainously.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="card shadow-2-strong h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      situation.just simply get to know your problem and we will
              ...
              <div className="col-lg-4 mb-8 mb-lg-0">
                <div className="card shadow-2-strong h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      This platform is completely safe and solid .So you don't
                      have to worry about any fraud and scam.
                    </p>
                  </div>
                </div>
              </div>
